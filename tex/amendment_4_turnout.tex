...
\input{"table3_precinct_turnout.tex"}
\end{singlespace}
...
{\centering \includegraphics{figure1_marginal_effects_1} 
...
\input{"table4_precinct_support_rolloff.tex"}
\end{singlespace}
...
{\centering \includegraphics{figure2_marginal_support} 

}

\caption{\label{fig:marg-alt}Marginal Effect of Formerly Incarcerated Residents on Support for Amendment 4}
\end{figure}
\begin{figure}[H]

{\centering \includegraphics{figure3_marginal_rolloff} 
...
\begin{singlespace}
\input{"table5_full_dind_reg.tex"}
\end{singlespace}
