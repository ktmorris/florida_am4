...
\begin{singlespace}
```{r dind-reg-chunk, echo = F, results = "hide", message = F, warning = F}
load("./temp/full_match_reg.rdata")

stargazer(m1, m2,
          header = F,
          type = "latex", notes.align = "l",
          covariate.labels = c("D(2018)", "D(Treated)", "D(2018) $\\times$ D(Treated)"),
          dep.var.labels.include = FALSE,
...
```{r dind-groups, echo = FALSE, message = F, warning = F, fig.width = 7.5, fig.height = 5, fig.cap = "\\label{fig:dind-groups}Estimated Treatment Effect by Group", fig.pos = "H", fig.align = "center"}
load("./temp/coef_plot.rdata")
p
```
