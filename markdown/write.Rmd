...
Over the past two decades, the literature has grappled with the relationship between the criminal justice system, felony disenfranchisement, and voter turnout. Following the 2000 presidential election, @Uggen2002 argued that George W. Bush won the state of Florida, and ultimately the presidency, thanks to felony disenfranchisement laws. Their analysis raised important questions about the representational effects of felony disenfranchisement rules.
...
stargazer(neg_binom,
          ...
          order = c(1, 2, 42),
          dep.var.labels.include = FALSE,
          title = "\\label{tab:neg-bin} Monthly Registrations, 2010 --- 2018",
          table.placement = "H",
          omit.stat = c("f", "ser"),
          omit = c("US_Congressional_District", "female"),
          table.layout = "-cm#-t-a-s-n",
          ...
          out.header = F,
          notes = "TO REPLACE",
          se = list(coef(summary(neg_binom, cluster = c("US_Congressional_District")))[, 2]),
          add.lines=list(c("Congressional District FEs" , "X")))
...
Table \ref{tab:other-precincts} demonstrates that, although Amendment 4 does not appear to have boosted precinct-level turnout relative to other precincts' turnout, precincts with more formerly incarcerated residents *did* support Amendment 4 at slightly higher rates. Similarly, roll-off was lower in these neighborhoods, which means that a higher share of residents expressed a preference on the question. Thus it appears that the presence of formerly incarcerated individuals in a neighborhood was not associated with getting people into the polling place, it was associated with how voters who *did* participate cast their ballots.
